        ...
        for iCondPlusAll = condLoop % Loop through the main and pooled conditions
          ...
          for sh = 1:numel(fieldnames(dbStruct.shankData))
            ...
            for u = 1:numel(units)
              ...
              coh1 = shankStruct.pupil.unitData{iU}.coh_halves(1,:);
              cohConf1 = shankStruct.pupil.unitData{iU}.coh_conf_halves(1,:);
              rateadjust_kappa1 = shankStruct.pupil.unitData{iU}.rateadjust_kappa_halves(1,:);
              phase1 = shankStruct.pupil.unitData{iU}.phase_halves(1,:);
              phaseConfU1 = shankStruct.pupil.unitData{iU}.phase_conf_halves(1,:);
              phaseConfL1 = shankStruct.pupil.unitData{iU}.phase_conf_halves(2,:);
...
%                 phaseConfU1, phaseConfL1, coh1, cohConf1, rateadjust_kappa1);
              ...
              coh2 = shankStruct.pupil.unitData{iU}.coh_halves(2,:);
              cohConf2 = shankStruct.pupil.unitData{iU}.coh_conf_halves(2,:);
              rateadjust_kappa2 = shankStruct.pupil.unitData{iU}.rateadjust_kappa_halves(2,:);
              phase2 = shankStruct.pupil.unitData{iU}.phase_halves(2,:);
              phaseConfU2 = shankStruct.pupil.unitData{iU}.phase_conf_halves(3,:);
              phaseConfL2 = shankStruct.pupil.unitData{iU}.phase_conf_halves(4,:);
...
if qualityCheck
  filename = [fileparts(mainFolderPhase) filesep 'globalHalfUnits_area2pupil_quality.mat'];
else
  filename = [fileparts(mainFolderPhase) filesep 'globalHalfUnits_area2pupil.mat']; %#ok<*UNRCH>
end
if fullRun

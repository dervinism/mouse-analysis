...
elseif strcmpi(dataset, 'neuropixels')
  ...
  derivedDataFolderNWB = [rootFolder filesep '03_data' filesep '102_uol_neuropixels_exp_derived_data' filesep 'NWB']; % Derived Neuropixels data for all animals placed in NWB format
end
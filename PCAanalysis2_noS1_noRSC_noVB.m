...
for dbCount = dbStart:numel(fnsData)
  ...
  elseif numel(seriesName) == 15 &&...
      (strcmpi(seriesName(15), '1') || strcmpi(seriesName(15), '2') || strcmpi(seriesName(15), '4') ||...
  ...
  if dbCount == numel(fnsData) || ~strcmpi(seriesName(1:14), seriesNameNext(1:14)) ||...
    ...
    for iArea = 1:numel(areasOI)
      ...
      dataString = ['dataStruct.seriesData.' entryNames{iArea} '.pcaData2_noS1_noRSC_noVB = pcaData;'];
      eval(dataString);

...
% relevant data that was already produced in AnPSD_units_ca.
...
for dbCount = dbEntries_caLocal % Loop through db entries
  ...
  % Save data
  dataString = ['dataStruct.seriesData_ca.' fnsData_ca{dbCount} '.popData.phaseCohHalves = phaseCohHalvesDB;'];
  eval(dataString);

...
% PLOT THE DATA
  coh = dbStruct.lfpphaseCohData.rippleRate{ch{dbCount}}.coh;
  coh(isnan(dbStruct.lfpphaseCohData.rippleRate{ch{dbCount}}.coh_conf)) = NaN;
  coh_confL = coh - dbStruct.lfpphaseCohData.rippleRate{ch{dbCount}}.coh_conf;
...
set(figH, 'Name','Ripple rate coherence with pupil area size');
figFileName = [dataDir filesep lfp2pupilDir filesep 'rippleRate2pupilCoh'];

  ...
  for dbCount = 1:numel(fnsData)
    ...
    for i = 1:2 % Repeat twice to deal with non-specific condition assignment
      ...
      [fH_varExpArea{condition}{area}, varExpArea{condition}{area}, varExpAreaLegend{condition}{area}] = plotAssign(...
        fH_varExpArea{condition}{area}, torow(dbStruct.pcaData4.explained_area_UFR), animalColour,...
      ...
      [fH_cumVarExpArea{condition}{area}, cumVarExpArea{condition}{area}, cumVarExpAreaLegend{condition}{area}] = plotAssign(...
        fH_cumVarExpArea{condition}{area}, cumsum(torow(dbStruct.pcaData4.explained_area_UFR)), animalColour,...
      ...
      if area == 1
        [fH_varExpSeries{condition}, varExpSeries{condition}, varExpSeriesLegend{condition}] = plotAssign(...
          fH_varExpSeries{condition}, torow(dbStruct.pcaData4.explained_UFR), animalColour,...
        ...
        [fH_cumVarExpSeries{condition}, cumVarExpSeries{condition}, cumVarExpSeriesLegend{condition}] = plotAssign(...
          fH_cumVarExpSeries{condition}, cumsum(torow(dbStruct.pcaData4.explained_UFR)), animalColour,...
        ...
        if isfield(dbStruct.pcaData4, 'rPCs2pupilAreaSpearman')
          [fH_corrPupilSeries{condition}, corrPupilSeries{condition}, corrPupilSeriesLegend{condition}] = plotAssign(...
            fH_corrPupilSeries{condition}, real(torow(dbStruct.pcaData4.rPCs2pupilAreaSpearman_UFR)), animalColour,...
          ...
          [fH_varExpPupilSeries{condition}, varExpPupilSeries{condition}, varExpPupilSeriesLegend{condition}] = plotAssign(...
            fH_varExpPupilSeries{condition}, (real(torow(dbStruct.pcaData4.rPCs2pupilAreaSpearman_UFR))).^2, animalColour,...
        ...
        if isfield(dbStruct.pcaData4, 'rPCs2motionSpearman')
          [fH_corrMotionSeries{condition}, corrMotionSeries{condition}, corrMotionSeriesLegend{condition}] = plotAssign(...
            fH_corrMotionSeries{condition}, real(torow(dbStruct.pcaData4.rPCs2motionSpearman_UFR)), animalColour,...
          ...
          [fH_varExpMotionSeries{condition}, varExpMotionSeries{condition}, varExpMotionSeriesLegend{condition}] = plotAssign(...
            fH_varExpMotionSeries{condition}, (real(torow(dbStruct.pcaData4.rPCs2motionSpearman_UFR))).^2, animalColour,...
      ...
      if area == 2
        VB_PCs_v = torow(dbStruct.pcaData4.explained_area_UFR(1:nPCs2plot));
        VB_PCs = cumsum(torow(dbStruct.pcaData4.explained_area_UFR(1:nPCs2plot)));
      elseif area == 5
        CA1_PCs_v = torow(dbStruct.pcaData4.explained_area_UFR(1:nPCs2plot));
        CA1_PCs = cumsum(torow(dbStruct.pcaData4.explained_area_UFR(1:nPCs2plot)));
        for iPC = 1:nPCs2plot

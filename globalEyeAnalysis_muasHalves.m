...
% recording halves for area-to-pupil comparisons.
%
% The following data files are produced:
% dataDir\area2pupil\unitsFolder\phaseCorrelationsSubfolder\globalHalfUnits_area2pupil.mat or
%   dataDir\area2pupil\qualityUnitsFolder\phaseCorrelationsSubfolder\globalHalfUnits_area2pupil_quality.mat or
...
%   in dataDir\area2pupil\unitsFolder\phaseCorrelationsSubfolder or
%   dataDir\area2pupil\qualityUnitsFolder\phaseCorrelationsSubfolder.
      ...
      for iAreaPlusAll = area % Loop through the main and pooled areas
        ...
        for iCondPlusAll = condLoop % Loop through the main and pooled conditions
          ...
          for u = 1:numel(units)
            ...
            freq = dbStruct.popData.pupil.phaseCoh.unitData{u}.coh_halves_freq;
            freqPSD = dbStruct.popData.pupil.phaseCoh.unitData{u}.psd_halves_freq;
            if sum(~isnan(freq)) < sum(~isnan(freqPSD))
              freq = freqPSD;
            end
            coh1 = dbStruct.popData.pupil.phaseCoh.unitData{u}.coh_halves(1,:);
            cohConf1 = dbStruct.popData.pupil.phaseCoh.unitData{u}.coh_conf_halves(1,:);
            rateadjust_kappa1 = dbStruct.popData.pupil.phaseCoh.unitData{u}.rateadjust_kappa_halves(1,:);
            phase1 = dbStruct.popData.pupil.phaseCoh.unitData{u}.phase_halves(1,:);
            phaseConfU1 = dbStruct.popData.pupil.phaseCoh.unitData{u}.phase_conf_halves(1,:);
            phaseConfL1 = dbStruct.popData.pupil.phaseCoh.unitData{u}.phase_conf_halves(2,:);
            ...
            coh2 = dbStruct.popData.pupil.phaseCoh.unitData{u}.coh_halves(2,:);
            cohConf2 = dbStruct.popData.pupil.phaseCoh.unitData{u}.coh_conf_halves(2,:);
            rateadjust_kappa2 = dbStruct.popData.pupil.phaseCoh.unitData{u}.rateadjust_kappa_halves(2,:);
            phase2 = dbStruct.popData.pupil.phaseCoh.unitData{u}.phase_halves(2,:);
            phaseConfU2 = dbStruct.popData.pupil.phaseCoh.unitData{u}.phase_conf_halves(3,:);
            phaseConfL2 = dbStruct.popData.pupil.phaseCoh.unitData{u}.phase_conf_halves(4,:);
...
filename = [fileparts(mainFolderPhase) filesep 'globalHalfMUAs_area2pupil.mat'];
if fullRun
...
options.phaseLim = phaseLim + pi/2;
